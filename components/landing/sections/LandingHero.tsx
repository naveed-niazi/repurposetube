  ...
  return (
    <section className="relative overflow-hidden bg-stone-950 pb-24 pt-24 sm:pt-32">
      ...
      <div className="relative mx-auto max-w-4xl px-5 text-center sm:px-8">
        ...
        <h1 className="font-heading mb-6 text-[clamp(1.375rem,7.5vw,3.75rem)] font-extrabold leading-[1.15] tracking-tight text-stone-50 text-pretty [&>br]:hidden sm:[&>br]:block">
          {headline}
        </h1>
